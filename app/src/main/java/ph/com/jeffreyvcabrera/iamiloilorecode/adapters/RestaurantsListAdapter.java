...
public class RestaurantsListAdapter extends BaseAdapter {
    ...
    private AQuery aq;
    Context c;
    ArrayList<RestaurantsModel> cm;
    private LayoutInflater inflater;

    public RestaurantsListAdapter(Context c, ArrayList<RestaurantsModel> cm) {
        this.c = c;
        this.cm = cm;
    }
...
//        final ViewHolder holder;
        ...
        if(convertView==null){
            ...
            v = li.inflate(R.layout.restaurants_row, viewGroup, false);
        ...
        String imgaq = Settings.base_url + "/assets/images/restaurants/" + cm.get(i).getImage();
        ...
        row_restaurant.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(c, RestaurantsPage.class);
