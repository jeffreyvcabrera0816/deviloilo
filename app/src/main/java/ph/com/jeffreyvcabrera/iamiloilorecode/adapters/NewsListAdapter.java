...
public class NewsListAdapter extends BaseAdapter {
    ...
    private AQuery aq;
    Context c;
    ArrayList<NewsModel> cm;
    private LayoutInflater inflater;

    public NewsListAdapter(Context c, ArrayList<NewsModel> cm) {
        this.c = c;
        this.cm = cm;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            v = inflater.inflate(R.layout.news_row, viewGroup, false);

        } else {
            v = view;
        }
        this.aq = new AQuery(v);
        String imgaq = Settings.base_url + "/assets/images/announcements/" + cm.get(i).getImage();
        ...
        date.setText(cm.get(i).getPost_date());

        row_news.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(c, NewsPage.class);
